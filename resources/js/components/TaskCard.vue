<template>
  <div
      :id="`phase-${props.phase_id}`"
      :key="props.task.id" class="w-full bg-white text-gray-900 shadow-md rounded-lg p-3 pb-8 mb-4 relative"
       :class="props.task.completed_at ? '!bg-green-200' : ''"
